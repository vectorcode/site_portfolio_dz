			...
			<div class="wrap-st-2">
				<article class="main-content">
					<section class="main-cnt-bl">
						<div class="main-cnt-bl-title">Основная информация</div>
						<div class="main-cnt-bl-body">
							<figure class="main-cnt-avatar-bl">
								<img src="img/ava.jpg" height="150" width="150" alt="avatar" class="main-cnt-avatar-img">
								<figcaption></figcaption>
							</figure>
							<ul class="main-cnt-data">
								<li class="main-cnt-data-item">
									<span class="main-cnt-data-item-title">Меня зовут:</span><div class="main-cnt-data-item-cnt">Павел Кондаков</div>
								</li>
								<li class="main-cnt-data-item">
									<span class="main-cnt-data-item-title">Мой возраст:</span><div class="main-cnt-data-item-cnt">26 лет</div>
								</li>
								<li class="main-cnt-data-item">
									<span class="main-cnt-data-item-title">Мой город:</span><div class="main-cnt-data-item-cnt">Орёл, Россия</div>
								</li>
								<li class="main-cnt-data-item">
									<span class="main-cnt-data-item-title">Моя специализация:</span><div class="main-cnt-data-item-cnt">FRONTEND разработчик</div>
								</li>
								<li class="main-cnt-data-item key_nv">
									<span class="main-cnt-data-item-title no-bold">Ключевые навыки:</span><div class="main-cnt-data-item-cnt">
										<ul class="skils-bl">
